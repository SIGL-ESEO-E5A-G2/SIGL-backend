...
router.register('tuteurpedagogiquedetail', TuteurPedagogiqueDetailViewSet, basename='utilisateurs')
router.register('maitrealternance', MaitreAlternanceViewSet, basename='utilisateurs')
router.register('maitrealternancedetail', MaitreAlternanceDetailViewSet, basename='utilisateurs')
router.register('coordinatricealternance', CoordinatriceAlternanceViewSet, basename='utilisateurs')
router.register('coordinatricealternancedetail', CoordinatriceAlternanceDetailViewSet, basename='utilisateurs')
