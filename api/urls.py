...
router.register('responsablefinance', ResponsableFinanceViewSet, basename='responsablefinance')
router.register('responsablefinancedetail', ResponsableFinanceDetailViewSet, basename='responsablefinancedetail')
router.register('responsableadministration', ResponsableAdministrationViewSet, basename='responsableadministration')
router.register('responsableadministrationdetail', ResponsableAdministrationDetailViewSet, basename='responsableadministrationdetail')
